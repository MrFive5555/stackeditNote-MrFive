...
&=(
\left[\begin{matrix}\Phi^T(m)& \phi_m \\ \end{matrix}\right]
\left[\begin{matrix}\Phi(m) \\ \phi_m^T\end{matrix}\right]
) ^{-1}
\left[\begin{matrix}\Phi^T(m)& \phi_m \\ \end{matrix}\right]
\left[\begin{matrix}y(m-1) \\ y_m\end{matrix}\right] \\ \\
&=P(m)(\Phi^T(m)y(m-1)+\phi_my_m) \\ \\
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ4ODQyNjA5MV19
-->